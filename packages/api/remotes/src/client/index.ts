...
import usageRemote from '@deepseek-ai/dsh-host-usage/remote'
...
export type { UsageProviderId, UsageReport, UsageSnapshot, UsageWindow } from '@deepseek-ai/dsh-host-usage/types'
...
export type {} from '@deepseek-ai/dsh-host-usage/remote'
...
export async function apply(ctx: Context): Promise<() => Promise<void>> {
  ...
  try {
    for (const contribution of [
      ...
      pluginInventoryRemote, usageRemote, messageFeedbackRemote, sessionReferencesRemote,
